...
## Modication of the original call: if the program fails (sometimes because of
# problems in the network -- 'Resource temporarily unavailable'), it is called
...
print Q "ret=1\n";
print Q "iter=0\n";
print Q "wait=(0.2 0.5 0.5 0.5 0.5 0.5 0.5 1.0 1.0 1.0 2.0 2.0 2.0 5.0)\n";
print Q "while [ \$ret != 0 ] && [ \$iter -lt \${#wait[\@]} ]; do\n";
print Q "\t( $cmd ) 2>>$logfile >>$logfile\n";
print Q "\tret=\$?\n";
print Q "\tif [ \$ret != 0 ]; then\n";
print Q "\t\tsleep \${wait[\$iter]}\n";
print Q "\t\techo Job failed... Retrying. >>$logfile\n";
print Q "\t\titer=\$[iter+1]\n";
print Q "\tfi\n";
print Q "done\n";
# End
