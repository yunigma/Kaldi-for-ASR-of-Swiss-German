...
#
# Adaptation of steps/nnet2/train_discriminative2.sh for UZH.
#
# Runs discriminative training taking as input the nnet2 models trained with
# uzh/run_5d.sh.
#
# Three types of discriminative training are supported:
# 
# * MPE
# * MMI
# * state-level minimum bayes risk (sMBR) (default)
