...
[ -x local/wer_output_filter ] && ref_filtering_cmd="uzh/wer_output_filter"
[ -x local/wer_ref_filter ] && ref_filtering_cmd="uzh/wer_ref_filter"
hyp_filtering_cmd="cat"
[ -x local/wer_output_filter ] && hyp_filtering_cmd="uzh/wer_output_filter"
[ -x local/wer_hyp_filter ] && hyp_filtering_cmd="uzh/wer_hyp_filter"
